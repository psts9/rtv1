...
/*
	...
	obj.material.type		= LAMBERTIAN;
	obj.material.albedo		= (t_vec3) {  0.0,  0.0,  1.0 };
	obj.material.fuzz		= 0.01;
	objlist_push_back(&result, obj);
*/
	obj.type				= PLANE;
	obj.position			= (t_vec3) {  0.0,  0.0, -10.0 };
	obj.scale				= (t_vec3) {  0.0,  0.0,  0.0 };
	obj.rotation			= (t_vec3) {  90.0,  0.0, 0.0 };
	obj.material.type		= LAMBERTIAN;
	obj.material.albedo		= (t_vec3) {  1.0,  0.0,  0.0 };
	obj.material.fuzz		= 0.01;
	objlist_push_back(&result, obj);
	obj.type				= PLANE;
	obj.position			= (t_vec3) {  0.0,  0.0, -0.0 };
	obj.scale				= (t_vec3) {  0.0,  0.0,  0.0 };
	obj.rotation			= (t_vec3) {  90.0,  0.0, 90.0 };
	obj.material.type		= LAMBERTIAN;
	obj.material.albedo		= (t_vec3) {  0.8,  0.8,  0.8 };
	obj.material.fuzz		= 0.01;
	objlist_push_back(&result, obj);
	obj.type				= SPHERE;
	obj.position			= (t_vec3) {  1.0,  0.5, -4.0 };
	...
	objlist_push_back(&result, obj);
	obj.type				= CYLINDER;
	obj.position			= (t_vec3) {  0.0,  0.0, -4.0 };
	...
	objlist_push_back(&result, obj);
	obj.type				= CONE;
	obj.position			= (t_vec3) { -1.0,  0.3, -4.0 };
	obj.scale				= (t_vec3) {  0.2,  1.0,  0.5 };
	obj.material.type		= LAMBERTIAN;
